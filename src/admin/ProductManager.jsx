      ...
      {editedProducts.map((prod, i) => (
        <div key={prod.id} style={{ marginBottom: 20, border: '1px solid #444', padding: 15, borderRadius: 5 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10 }}>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>a (Stonex)</label>
              <input
                type="text"
                value={prod.a}
                onChange={(e) => handleChange(i, 'a', e.target.value)}
                placeholder="a (Stonex)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>a (Stonex Plus)</label>
              <input
                type="text"
                value={prod.aPlus}
                onChange={(e) => handleChange(i, 'aPlus', e.target.value)}
                placeholder="a (Stonex Plus)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>b (Stonex)</label>
              <input
                type="text"
                value={prod.b}
                onChange={(e) => handleChange(i, 'b', e.target.value)}
                placeholder="b (Stonex)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>b (Stonex Plus)</label>
              <input
                type="text"
                value={prod.bPlus}
                onChange={(e) => handleChange(i, 'bPlus', e.target.value)}
                placeholder="b (Stonex Plus)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>c (Stonex)</label>
              <input
                type="text"
                value={prod.c}
                onChange={(e) => handleChange(i, 'c', e.target.value)}
                placeholder="c (Stonex)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>c (Stonex Plus)</label>
              <input
                type="text"
                value={prod.cPlus}
                onChange={(e) => handleChange(i, 'cPlus', e.target.value)}
                placeholder="c (Stonex Plus)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>d (Stonex)</label>
              <input
                type="text"
                value={prod.d}
                onChange={(e) => handleChange(i, 'd', e.target.value)}
                placeholder="d (Stonex)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>d (Stonex Plus)</label>
              <input
                type="text"
                value={prod.dPlus}
                onChange={(e) => handleChange(i, 'dPlus', e.target.value)}
                placeholder="d (Stonex Plus)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>Panel Size (Stonex)</label>
              <input
                type="text"
                value={prod.panelSize}
                onChange={(e) => handleChange(i, 'panelSize', e.target.value)}
                placeholder="Panel Size (Stonex)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>Panel Size (Stonex Plus)</label>
              <input
                type="text"
                value={prod.panelSizePlus}
                onChange={(e) => handleChange(i, 'panelSizePlus', e.target.value)}
                placeholder="Panel Size (Stonex Plus)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>Installed Exposure (Stonex)</label>
              <input
                type="text"
                value={prod.installedExposure}
                onChange={(e) => handleChange(i, 'installedExposure', e.target.value)}
                placeholder="Installed Exposure (Stonex)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>Installed Exposure (Stonex Plus)</label>
              <input
                type="text"
                value={prod.installedExposurePlus}
                onChange={(e) => handleChange(i, 'installedExposurePlus', e.target.value)}
                placeholder="Installed Exposure (Stonex Plus)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>Tiles per Square Meter (Stonex)</label>
              <input
                type="text"
                value={prod.tilesPerSquareMeter}
                onChange={(e) => handleChange(i, 'tilesPerSquareMeter', e.target.value)}
                placeholder="Tiles per Square Meter (Stonex)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>Tiles per Square Meter (Stonex Plus)</label>
              <input
                type="text"
                value={prod.tilesPerSquareMeterPlus}
                onChange={(e) => handleChange(i, 'tilesPerSquareMeterPlus', e.target.value)}
                placeholder="Tiles per Square Meter (Stonex Plus)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>Installed Weight (Stonex)</label>
              <input
                type="text"
                value={prod.installedWeight}
                onChange={(e) => handleChange(i, 'installedWeight', e.target.value)}
                placeholder="Installed Weight (Stonex)"
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: 5 }}>Installed Weight (Stonex Plus)</label>
              <input
                type="text"
                value={prod.installedWeightPlus}
                onChange={(e) => handleChange(i, 'installedWeightPlus', e.target.value)}
                placeholder="Installed Weight (Stonex Plus)"
                style={{ width: '100%' }}
              />
            </div>
          </div>
